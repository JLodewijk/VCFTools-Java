       ...
       public void parse(String[] args){
        ...
        CommandLineParser parser = new BasicParser();
           try {
               ...
               if(args.length > 1){processOptions(cmd);}
...
//         opt.addOption("<oneLetterOption>","<multipleLetterOption>",true,"description"); // true = can accept arguments, false = can not accept arguments
         ...
         opt.addOption("exclude", true, "exclude a list of SNPs given in a file. The file should contain a list of SNP IDs, with one ID per line");
         opt.addOption("positions", true, "include a set of sites on the basis of a list of positions in a file");
         ...
         opt.addOption("bed", true, "exclude a set of sites on the basis of a BED files");
