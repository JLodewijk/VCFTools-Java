...
public class SiteFilters {
     ...
     */
    public void AlleleFrequencies(VariantContext line, double minAlleleFreq, double maxAlleleFreq, boolean args) {
        if (args = true) {
            ...
            if (valObj instanceof String) {
                ...
                if (val < maxAlleleFreq && val > minAlleleFreq) {
                    System.out.println("Line is approved allelfreq " + line.getAttribute("AF") + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                } else {
                    System.out.println("Line is rejected allelfreq " + line.getAttribute("AF") + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                }
                ...
                if (reject == true) {
                    System.out.println("Line is reject allelfreq: " + valuesDoubles + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                } else {
                    System.out.println("Line is approve allelfreq: " + valuesDoubles + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                }

            }
        } else {
            Object valObj = line.getAttribute("MLEAF");
            boolean reject = false;
            ...
            if (valObj instanceof String) {
                ...
                if (val < maxAlleleFreq && val > minAlleleFreq) {
                    System.out.println("Line is approved Nonallelfreq " + line.getAttribute("MLEAF") + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                } else {
                    System.out.println("Line is rejected Nonallelfreq " + line.getAttribute("MLEAF") + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                }
                ...
                //check if to reject or approve SNP
                if (reject == true) {
                    System.out.println("Line is reject Nonallelfreq: " + valuesDoubles + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                } else {
                    System.out.println("Line is approve Nonallelfreq: " + valuesDoubles + " is between " + minAlleleFreq + " and " + maxAlleleFreq);
                }
